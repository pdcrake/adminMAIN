...
<div class="wrapper">
    ...
    <div class="content" id="container">
      ...
      echo "<script> var arra1 = ".array()."; var erer = null; var d1 = ".json_encode($var1)."; var d2 = ".json_encode($var2)."; var d3 = ".json_encode($var3).";</script>";?>
      ...
      echo "<script> var yne = ['меньше 15', '15-18', '18-21', '21-24', '24-27', '27-30', '30-33', '33-36', '36 и выше']; var arra1 = ".array()."; var d1_h = ".json_encode($var11).";</script>";?>
        ...
        <div class="widget">
            ...
            <?php             
              ...
              /*for ($i=8; $i < 18; $i++) { 
                ...
                $client = Client::model()->findByPk(3);
                  $marks = 0;
                  $marks += Mark::model()->countByAttributes(array('cid'=>$client->cid));                
                  $certs = Certificate::model()->findAllByAttributes(array('cid'=>$client->cid));
                  $orders = 0;
                  ...
                  $rows[] = array($i, $marks);
                  $rows2[] = array($i, $orders);
                  $rows3[] = array($i, $client->title);              
              }*/
