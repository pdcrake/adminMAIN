...
JS_PREVIEW;
            ...
            if (is_array($this->options)) {
                if (!isset($this->options['onSelectEnd'])) {
                    $this->options['onSelectEnd'] = /*"js:function (targetImg, selection) {
                    ...
                    "js:function(sourceImg,selection){
                    $('#width').val(sourceImg.width);
                    $('#height').val(sourceImg.height);    
                    $('#x1').val(selection.x1);
                    $('#y1').val(selection.y1);
                    $('#x2').val(selection.x2);
                    $('#y2').val(selection.y2);
